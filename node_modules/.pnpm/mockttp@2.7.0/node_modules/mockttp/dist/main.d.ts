 ...
 */
export declare type MockRuleData = RequestRuleData;
/**
 * @deprecated alias for getAdminServer.
 */
export declare const getStandalone: typeof getAdminServer;
/**
 * @deprecated alias for resetAdminServer
 */
export declare const resetStandalone: typeof resetAdminServer;
/**
 * @deprecated alias for MockttpAdminServerOptions
 */
export declare type StandaloneServerOptions = MockttpAdminServerOptions;
/**
 * @deprecated alias for MockttpAdminServer
 */
export declare type MockttpStandalone = MockttpAdminServer;
