...
import { ProxyEnvConfig, MockedEndpoint, CompletedRequest, CompletedResponse, TlsRequest, InitiatedRequest, ClientError } from "./types";
...
export declare type SubscribableEvent = 'request-initiated' | 'request' | 'response' | 'abort' | 'tls-client-error' | 'tlsClientError' | 'client-error';
/**
 * @hidden
 */
export declare abstract class AbstractMockttp {
    ...
    anyRequest: () => RequestRuleBuilder;
    unmatchedRequest: () => RequestRuleBuilder;
    get: (url?: string | RegExp | undefined) => RequestRuleBuilder;
    post: (url?: string | RegExp | undefined) => RequestRuleBuilder;
    put: (url?: string | RegExp | undefined) => RequestRuleBuilder;
    delete: (url?: string | RegExp | undefined) => RequestRuleBuilder;
    patch: (url?: string | RegExp | undefined) => RequestRuleBuilder;
    head: (url?: string | RegExp | undefined) => RequestRuleBuilder;
    options: (url?: string | RegExp | undefined) => RequestRuleBuilder;
    anyWebSocket: () => WebSocketRuleBuilder;
}
