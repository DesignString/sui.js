...
exports.deserializeProxyConfig = exports.serializeProxyConfig = exports.ensureParamsDeferenced = exports.maybeSerializeParam = exports.withDeserializedBodyBuffer = exports.withSerializedBodyBuffer = exports.withDeserializedBodyReader = exports.withSerializedBodyReader = exports.deserializeBuffer = exports.serializeBuffer = exports.ClientServerChannel = exports.Serializable = exports.deserialize = exports.serialize = void 0;
...
function withDeserializedBodyReader(input) {
    return Object.assign({}, input, {
        body: (0, request_utils_1.buildBodyReader)(deserializeBuffer(input.body), input.headers)
    });
}
...
function withSerializedBodyBuffer(input) {
    ...
    if (!input.body) {
        ...
        serializedBody = serializeBuffer((0, buffer_utils_1.asBuffer)(input.body));
    }
        ...
        serializedBody = serializeBuffer((0, buffer_utils_1.asBuffer)(input.body.buffer));
    }
...
function deserializeProxyConfig(proxyConfig, channel, ruleParams) {
    if (_.isString(proxyConfig)) {
        ...
        const proxyConfigCallback = (options) => __awaiter(this, void 0, void 0, function* () {
            return yield channel.request(callbackId, options);
        });
