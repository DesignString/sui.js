...
class CachedDns {
    constructor(cacheDurationMs) {
        ...
        this.lookup = (...args) => {
            ...
            if (cachedResult) {
                ...
                dns.lookup(hostname, options !== null && options !== void 0 ? options : {}, (err, ...cbArgs) => {
                    if (!err) {
    ...
    cacheKey(hostname, options) {
        return `${hostname}-${options === null || options === void 0 ? void 0 : options.all}-${options === null || options === void 0 ? void 0 : options.family}-${options === null || options === void 0 ? void 0 : options.hints}-${options === null || options === void 0 ? void 0 : options.verbatim}`;
    }
}
