...
class CallbackMatcher extends serialization_1.Serializable {
    ...
    matches(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const completedRequest = yield (0, request_utils_1.waitForCompletedRequest)(request);
    ...
    serialize(channel) {
        channel.onRequest((streamMsg) => __awaiter(this, void 0, void 0, function* () {
            const request = (0, serialization_1.withDeserializedBodyReader)(streamMsg);
    ...
    static deserialize({ name }, channel) {
        const rpcCallback = (request) => __awaiter(this, void 0, void 0, function* () {
            const callbackResult = channel.request((0, serialization_1.withSerializedBodyReader)(request));
            return callbackResult;
        });
