    ...
    serialize(channel) {
        channel.onRequest((streamMsg) => __awaiter(this, void 0, void 0, function* () {
            const request = _.isString(streamMsg.args[0].body)
                ? (0, serialization_1.withDeserializedBodyReader)(// New format: body serialized as base64
                streamMsg.args[0])
                : Object.assign(Object.assign({}, streamMsg.args[0]), { body: (0, request_utils_1.buildBodyReader)(streamMsg.args[0].body.buffer, streamMsg.args[0].headers) });
            const callbackResult = yield this.callback.call(null, request);
            if (typeof callbackResult === 'string') {
                return callbackResult;
            }
            else {
                return (0, serialization_1.withSerializedBodyBuffer)(callbackResult);
            }
        }));
    ...
    serialize(channel) {
        ...
        if (this.beforeRequest) {
            channel.onRequest('beforeRequest', (req) => __awaiter(this, void 0, void 0, function* () {
                const callbackResult = yield this.beforeRequest((0, serialization_1.withDeserializedBodyReader)(req.args[0]));
                const serializedResult = callbackResult
                    ? (0, serialization_1.withSerializedBodyBuffer)(callbackResult)
                    : undefined;
                if ((serializedResult === null || serializedResult === void 0 ? void 0 : serializedResult.response) && typeof (serializedResult === null || serializedResult === void 0 ? void 0 : serializedResult.response) !== 'string') {
                    serializedResult.response = (0, serialization_1.withSerializedBodyBuffer)(serializedResult.response);
                }
        ...
        if (this.beforeResponse) {
            channel.onRequest('beforeResponse', (req) => __awaiter(this, void 0, void 0, function* () {
                const callbackResult = yield this.beforeResponse((0, serialization_1.withDeserializedBodyReader)(req.args[0]));
                if (typeof callbackResult === 'string') {
                    return callbackResult;
                }
        ...
        return Object.assign(Object.assign({ type: this.type }, this.forwarding ? {
            ...
            }), clientCertificateHostMap: _.mapValues(this.clientCertificateHostMap, ({ pfx, passphrase }) => ({ pfx: (0, serialization_1.serializeBuffer)(pfx), passphrase })), transformRequest: Object.assign(Object.assign({}, this.transformRequest), { 
