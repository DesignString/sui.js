...
exports.matchesNoProxy = exports.getProxySetting = void 0;
const _ = require("lodash");
function getProxySetting(configSource, params) {
    return __awaiter(this, void 0, void 0, function* () {
        if (_.isFunction(configSource))
            ...
            for (let configArrayOption of configSource) {
                result = yield getProxySetting(configArrayOption, params);
                if (result)
                    break;
            }
            return result;
