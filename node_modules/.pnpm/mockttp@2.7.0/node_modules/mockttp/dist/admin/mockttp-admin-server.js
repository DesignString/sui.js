...
class MockttpAdminServer extends admin_server_1.AdminServer {
    constructor(options) {
        super(Object.assign(Object.assign({}, _.omit(options, 'serverDefaults')), { pluginDefaults: { http: { options: options.serverDefaults } }, adminPlugins: { http: mockttp_admin_plugin_1.MockttpAdminPlugin } }));
    }
}
